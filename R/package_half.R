                           ...
                           diagnostics=TRUE)
{
  ...
  if("easy" %in% difficulty)
  {
    ...
    easy_infection_curves = easy_infection_curves[1:120,]
    easy_symptom_onset_curves = easy_symptom_onset_curves[1:120,]
  ...
  if("medium" %in% difficulty)
  {
    ...
    medium_infection_curves = medium_infection_curves[1:120,]
    medium_symptom_onset_curves = medium_symptom_onset_curves[1:120,]
  ...
  if("hard" %in% difficulty)
  {
    ...
    hard_infection_curves = hard_infection_curves[1:120,]
    hard_symptom_onset_curves = hard_symptom_onset_curves[1:120,]
