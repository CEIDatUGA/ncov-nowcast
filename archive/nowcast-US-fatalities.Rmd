...
p <- plot_nowcast_from_death_reports(US.all, maxy = 10^8) %>% 
  plotly::layout(showlegend=TRUE, title="Nowcast for the US, estimated from fatalities")
htmlwidgets::saveWidget(p, "USnowcast_plot.html")

plot_nowcast_from_death_reports(US.all, maxy = 10^8)  %>% plotly::layout(showlegend=TRUE)
