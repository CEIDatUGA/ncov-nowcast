...
params.US$q <- get_ascertainment(cases.US.all, fatalities.US.all, params.US, window = 7, samplesize = 0.1)
...
get_nowcast <- function(admin, cases, fatalities, params, samplesize) {
...
# start.time <- proc.time()
US <- get_nowcast(admin = "US", cases = cases.US, fatalities = fatalities.US, params.US, samplesize = 0.1)
