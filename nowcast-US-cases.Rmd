...
# Export single plot
p <- plot_nowcast_from_case_reports(US, plotcumulative = TRUE, maxy = 10^8, legend = TRUE)
...
plot_nowcast_from_case_reports(US, maxy = 10^8, legend = TRUE)
```
...
# Export single plot
p <- plot_nowcast_from_case_reports(GA, plotcumulative = TRUE, maxy = 10^7, legend = TRUE)
